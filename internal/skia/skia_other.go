...
#cgo linux LDFLAGS: -L${SRCDIR} -lfontconfig -lfreetype -lGL -ldl -lm -lstdc++
#cgo linux,amd64 LDFLAGS: -L${SRCDIR} -lskia_linux_amd64
#cgo linux,arm64 LDFLAGS: -L${SRCDIR} -lskia_linux_arm64
